 ...
 * Buttons
 */
#define PIN_BUTTON1          (10)    // P0.09 - User button
 ...
 * Serial interfaces
 */
#define PIN_SERIAL1_RX       (20)   // P0.15
#define PIN_SERIAL1_TX       (19)   // P0.16
 ...
 */
#define P_LORA_DIO_1         (40)   // P1.06 - SX1262 DIO1/IRQ
 ...
 */
#define PIN_QSPI_SCK         (3)   // P0.19
#define PIN_QSPI_CS          (26)   // P0.17
#define PIN_QSPI_IO0         (30)   // P0.20
#define PIN_QSPI_IO1         (29)   // P0.21
#define PIN_QSPI_IO2         (28)   // P0.22
#define PIN_QSPI_IO3         (2)   // P0.23
